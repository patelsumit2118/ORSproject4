   ...
   <center>
    ...
    <div align="center">    
            ...
            <table>
                <tr>
                    ...
                    <td><input type="text" style="width: 212" name="firstName" placeholder="Enter First Name" size="25"  value="<%=DataUtility.getStringData(bean.getFirstName())%>"></td>
    ...
    <tr><th style="padding: 3px"></th></tr>          
              ...
              <tr>
                    ...
                    <td><input type="text" style="width: 212" name="lastName" placeholder="Enter Last Name" size="25" value="<%=DataUtility.getStringData(bean.getLastName())%>"></td>
    ...
    <tr><th style="padding: 3px"></th></tr>          
                ...
                <tr>
                    ...
                    <td><input type="text" style="width: 212" name="login" placeholder="Enter EmailId" size="25" value="<%=DataUtility.getStringData(bean.getLogin())%>"
    ...
    <tr><th style="padding: 3px"></th></tr>          
                ...
                <tr>
                    ...
                    <td><input type="password" style="width: 212" name="password" placeholder="Enter Password" size="25"value="<%=DataUtility.getStringData(bean.getPassword())%>"></td>
    ...
    <tr><th style="padding: 3px"></th></tr>          
                ...
                <tr>
                    ...
                    <td><input type="password" style="width: 212" name="confirmPassword" placeholder="Re-Enter Password" size="25" value="<%=DataUtility.getStringData(bean.getConfirmPassword())%>"></td>
    ...
    <tr><th style="padding: 3px"></th></tr>          
                ...
                <tr>
                    ...
                    <td><input type="text" style="width: 212px" name="dob" placeholder="Enter Date Of Birth" size= "25" readonly="readonly" id="udatee" value="<%=DataUtility.getDateString(bean.getDob())%>"></td>
    ...
    <tr><th style="padding: 3px"></th></tr>          
                ...
                <tr>
                    ...
                    <td><input type="text" style="width:212px" name="mobileNo" maxlength="10" placeholder="Enter Mobile No" size= "25" value="<%=DataUtility.getStringData(bean.getMobileNo())%>"></td>
