...
<center>
            ...
            <table align="center">
                <tr>
                    ...
                    <td><input width="212px" type="text" name="rollNo" placeholder="Enter RollNo" size="25"
                ...
                <tr><th style="padding: 3px"></th></tr>
                  ...
                  <td><input type="number" name="physics" maxlength="3" placeholder="Enter Physics Marks"  style="width:212px"
                ...
                <tr>
                    <th align="left">Chemistry<span style="color: red">*</span> :</th>
                     <td><input type="number" name="chemistry" maxlength="3" placeholder="Enter Chemistry Marks"  style="width:212px"
                ...
                <tr >
                  ...
                  <td><input type="number" name="maths" maxlength="3" placeholder="Enter Maths Marks"  style="width:212px"
